...
class MapItem o' o where
    type Mapped o :: Type
    mapItem :: (forall n. o' n -> n) -> o -> Mapped o
...
instance MapItem Object (Object n) where
...
map :: All (MapItem Object) xs => (forall n. Object n -> n) -> HList xs -> HList (MapAll MappedSym0 xs)
map _ HNil = HNil
